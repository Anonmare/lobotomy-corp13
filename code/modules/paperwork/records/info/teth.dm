...
/obj/item/paper/fluff/info/teth/cherryblossom
	...
	abno_info = list(
		...
		"When the Qliphoth Counter reached 0, five employees were marked for death. Whilst the mark is in effect, those affected recieved 4x as much damage from all sources than normal..",
